            ...
            if (shape !== 'None') {
                ...
                if (this.markerPoint[count]) {
                    ...
                    const tooltipContent = (this.formattedText && this.formattedText.length >= 2)
                        ...
                        : '';
                    markerGroup.appendChild(drawSymbol(new TooltipLocation(x, this.markerPoint[count] - this.padding + (isBottom ? this.arrowPadding : padding)), shape, new Size(size, size), this.markerImage, shapeOption, 'img', tooltipContent));
                }
                count++;
            }
        }
